...
@OpenAPIDefinition(info = @Info(title = "User Module MicroServices", version = "1.0.0", description = "User Module MicroServices"), servers = {
		@Server(url = "http://localhost:8080/user-api/api/") })
